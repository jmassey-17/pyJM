...
p.camera.position = (22.905388900878016, -22.905388900878016, 18.702171722386808)


#p.camera.position =  (97.01723378487242, 0.0, 0.0)
...
(0, 0, 0),
(-40, 1, 0)]
p.save_graphic(f'{t}_sideview45Deg.svg')
p.show()
