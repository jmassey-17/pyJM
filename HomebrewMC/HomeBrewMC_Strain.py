...
@timeOperation
def runMCSimSpinAndStrain(spins, J1, J2, D, NNTranslations, NNNTranslations, fourSpinTranslations, 
                          latticePosition, latticePositionDefault, translations, AFLatticeParameter, FMLatticeParameter, 
                          temperature, iterations, 
                          diagonalCoeff, nondiagonalCoeff,
                          preIterations, kB): 
    #Initialize
    energyTrace = []
...
SAVEDIR = r"C:\Data\FeRh\MC code\HomemadeMCTests\Overnight_20230620_Strain"
...
for temperature in temperatures:
    ...
    simulationParameters = {
        ...
        'latticePositionDefault': latticePositionDefault,
        'translations': translations,
        'AFLatticeParameter': AFLatticeParameter,
        'FMLatticeParameter': FMLatticeParameter,
        'temperature': temperature, 
        'iterations': iterations,
        'diagonalCoeff': diagonalCoeff, 
        'nondiagonalCoeff': nondiagonalCoeff,
        'preIterations': preIterations, 
        'kB': kB, 
        }

    spins, latticePosition, latticePositionDefault, energyTrace = runMCSimSpinAndStrain(**simulationParameters) 
    toSave = {
         'result' : spins, 
    ...
    for key in list(toSave.keys()): 
         filePath = f'{key}_{temperature}K_{xshape}_{yshape}_{zshape}_{iterations}_{dateToSave()}.npy'
         np.save(f'{os.path.join(SAVEDIR, filePath)}', toSave[key]) 
